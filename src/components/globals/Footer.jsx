        ...
        <div className="app-footer-grid">
          ...
          {linkSections.map((section) => (
            <div key={section.title}>
              <h3 className="app-footer-section-title">{section.title}</h3>
              <ul className="app-footer-links">
                {section.links.map((link) => (
                  <li key={link.label}>
                    <a href={link.path} className="app-footer-link">
                      {link.label}
                    </a>
                  </li>
                ))}
          ...
          <div>
            <h3 className="app-footer-section-title">Connect</h3>
            <div className="app-footer-social">
              {['twitter', 'github', 'linkedin'].map((s) => (
                <a key={s} href="#" className="app-footer-social-link" aria-label={s}>
                  <SocialIcon type={s} />
                </a>
              ))}
            </div>
